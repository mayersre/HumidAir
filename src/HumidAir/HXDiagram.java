...
public class HXDiagram extends JPanel {
    ...
    private static  double papw_min = AirPressure*(double)(XAxMin/1000.0)/(R_AIR_STEAM+(double)(XAxMin/1000.0)) *10.0;
    private static  double papw_max = AirPressure*(double)(XAxMax/1000.0)/(R_AIR_STEAM+(double)(XAxMax/1000.0)) *10.0;
    ...
    public static IsoLine calculate_RH_line(double rh, double xmin, double xmax, double AtmosphericPressure){
    	...
    	for (int i = 0; i < xdata.length; i++) {
    		...
    		ydata[i] = Enthalpy_p_phi_x(AtmosphericPressure/100.0,rh,xdata[i])-(double)(xdata[i]*R_0);
